            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        CheckBox {
                            id: historyToggle
                            text: "Enable playback history"
                            checked: SettingsManager.scrobblingEnabled

                            onToggled: {
                                SettingsManager.scrobblingEnabled = checked
                            }
                        ...
                        Image {
                            ...
                            MouseArea {
                                ...
                                ToolTip {
                                    id: historyTooltip
                                    visible: parent.containsMouse
                                    text: "When enabled, tracks you play are shown in the history list."
                                    delay: 200
                                    timeout: 8000
                                    background: Rectangle {
                                        color: Theme.isDark ? "#2b2b2b" : "#f0f0f0"
